...
import com.baukur.api.categories.domain.CreateDefaultCategoryPayload;
...
public class CategoriesController {
    ...
    @PostMapping("/default")
    public ResponseEntity<?> createDefaultCategories(@RequestBody CreateDefaultCategoryPayload payload) {
        try {
